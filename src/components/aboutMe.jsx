          ...
          <div className="card hovercard">
            ...
            <div className="bottom">
              ...
              <ul className="social_links">
                ...
                <li className="GitHub animated bounceIn wow delay-03s animated" style={{visibility: 'visible', animationName: 'bounceIn'}}><a href="https://github.com/xinrod"><img alt="" src="img/github-mark.svg" max-width="176" max-height="46"/><i className="fa fa-gitHub" /></a></li>
              </ul> 
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="top_left_cont intro zoomIn wow animated"> 
                    ...
                    <div className="underline" />             
                    <ul className="social_links">
                      <li className="linkedin animated bounceIn wow delay-02s animated" style={{visibility: 'visible', animationName: 'bounceIn'}}><a href="https://www.linkedin.com/in/roderick-liu-85325a1a2/"><img alt="" src="img/linkedin-icon.svg" max-width="176" max-height="46"/><i className="fa fa-linkedIn" /></a></li>
                      <li className="GitHub animated bounceIn wow delay-03s animated" style={{visibility: 'visible', animationName: 'bounceIn'}}><a href="https://github.com/xinrod"><img alt="" src="img/github-mark.svg" max-width="176" max-height="46"/><i className="fa fa-gitHub" /></a></li>
                    </ul> </div>
                </div> 
              </div>
